...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(mMap != null) {
            mMap.addMarker(new MarkerOptions().position(CAALAR)
                    .title("CaalaR in the HousE")
                    .snippet("HZ MUHAMMED OKUMA BILMIYORMUS"));

            mMap.addMarker(new MarkerOptions().position(SaiD)
                    .title("SaiDoW in the HousE")
                    .snippet("BANA VAR DENDI E BANA VAR DENDI"));

            PolylineOptions options = new PolylineOptions().add(CAALAR).add(SaiD).width(7).color(Color.GREEN).visible(true).geodesic(true);
            ...
            if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) ==
                ...
                ActivityCompat.requestPermissions(this, new String[] {
                                ...
                                Manifest.permission.ACCESS_COARSE_LOCATION },1530);
